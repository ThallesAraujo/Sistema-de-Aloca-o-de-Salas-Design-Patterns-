 ...
 *
 */
public class AdicionarEventoMensal {
	
	public AdicionarEventoMensal(){
		...
		Label rotuloRepSemanais = new Label("Repetições Mensais:");
			...
			public void handle(Event arg0) {
				try {
					...
					if(codigo.getText().contains(" ")){
						...
						Invoker.adicionarEExecutar(new ComandoAdicionarEvento(new Evento(codigo.getText(),nome.getText(),dataInicio+" "+tpDataInicio.getTime(),dataFim+" "+tpDataTermino.getTime(),responsavel.getText(),area.getText(),Integer.parseInt(repeticoes.getText()),"mensal")));
						mainStage.close();
